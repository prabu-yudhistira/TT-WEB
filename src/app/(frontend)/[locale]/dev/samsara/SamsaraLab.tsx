...
const GROUPS: { title: string; note?: string; rows: Row[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { kind: 'num', path: 'HOLOGRAM.SHAFT_REACH', label: 'Ray reach', min: 0.2, max: 6, step: 0.05 },
      ...
      { kind: 'num', path: 'HOLOGRAM.NEAR_SHAFT.SPREAD', label: 'Near fan spread ×', min: 0.05, max: 4, step: 0.05 },
      ...
      { kind: 'num', path: 'HOLOGRAM.FAR_SHAFT.SPREAD', label: 'Far fan spread ×', min: 0.05, max: 4, step: 0.05 },
